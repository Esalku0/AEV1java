...
public class Model {
	 ...
	 * @param1 es el nom o ruta del fitxer que anem a visualitzar
	...
	/**
	 * Aquest metode ens serveix per a poder llegir el contengunt d'un fitxer que pasem per parametre
	...
	/**
	 * 
	 * Aquest mètode ens permet accedir a un fitxer del nostre pc mitjançant una ruta i canviar-li el nom
	 * @param1 És el nom del fitxer que estem buscant per a reemplaçar
	 * @param2 És el nom que passarem per a reemplaçar al nom que ja estava
	 * @return Retorna true si s'ha pogut canviar de nom el fitxer i false si no s'ha pogut
	 */
	 ...
	 * @param1 És la ruta on voldrem crear el fitxer
	 */
	 ...
	 * @param1 És la ruta on voldrem eliminar el fitxer
	 */
	...
	/**
	 * Aquest mètode ens copiarà un arxiu en la mateixa ruta afegint-li un _Còpia al final
	 * @param1 Es la ruta o el nom del ficher original que anem a copiar
	 */
	...
	/**
	 * Açi podem trovar una paraula en el fitxer, fent un contador i si el trova aumentarlo
	 ...
	 * @param1 paraula que volem sutituir
	 * @param2 paraula que va a sustituir a la anterior
	 * @param3 nom o ruta del fitxer que anem a utilitzar
	 */
 ...
 * @param1 es el contingut del jtextarea que es pot modificar
 * @param2 la ruta on es va a guardar el contingut en un txt
 */
